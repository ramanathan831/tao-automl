...
@dataclass
class OCDNetTrtConfig(TrtConfig):
    """Trt config."""
...
@dataclass
class OCDNetGenTrtEngineExpConfig(GenTrtEngineConfig):
    """Gen TRT Engine experiment config."""

    # @seanf: OCDNet is unique in that it uses width and height upon engine construction
    width: int = INT_FIELD(
        value=1280,
        default_value=1280,
        valid_min=1,
